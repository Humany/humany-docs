...
- `HumanySeoAllowIndex` - optional, default is `true`. If present and value is `false`, then the page (currenly guides only) has requested not to be indexed by search engines.
